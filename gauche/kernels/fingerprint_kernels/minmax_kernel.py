...
def batch_minmax_sim(
    ...
    jaccard_similarity = (norm_sum - pairwise_dist + eps) / (norm_sum + pairwise_dist + eps)

    return jaccard_similarity.clamp_min_(0)  # zero out negative values for numerical stability
